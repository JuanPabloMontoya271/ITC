...
Interface::Interface(Graph graph, std::unordered_map<int, int> frequency_map)
{
    graph_ = graph;
...
void Interface::Run()
{
    graph_.DFS(1, frequency_map_);
    std::cout << "Max : "  << graph_.max_value[0] << " "<< graph_.max_value[1] <<  std::endl;
